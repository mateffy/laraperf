...
export default function BorderGlow({
  ...
  const handlePointerMove = useCallback((e) => {
    ...
    setEdgeProximity(getEdgeProx(card, x, y))
    setCursorAngle(getAngle(card, x, y))
  ...
  const maskCompositeValue = 'subtract, add, add, add, add, add'
  const webkitMaskCompositeValue = 'source-out, source-over, source-over, source-over, source-over, source-over'
  ...
  const fillStyle = {
    ...
    WebkitMaskComposite: webkitMaskCompositeValue,
  ...
  return (
    ...
    >
      <div className="absolute inset-0 rounded-[inherit] -z-[1]" style={borderStyle} />
      <div className="absolute inset-0 rounded-[inherit] -z-[1]" style={fillStyle} />
      <span className="absolute pointer-events-none z-[1] rounded-[inherit]" style={outerGlowStyle}>
        <span className="absolute rounded-[inherit]" style={innerGlowStyle} />
      </span>
