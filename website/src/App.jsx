      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm font-medium text-stone-500">
            ...
            <a href="#commands" className="hover:text-emerald-700 transition">
              Commands
            </a>
            <a href="#install" className="hover:text-emerald-700 transition">
              Install
            </a>
          </div>
        </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-stone-500">
              All output goes to{" "}
              <strong className="text-stone-700">stdout</strong>. Status lines
              go to <strong className="text-stone-700">stderr</strong>. Safe to
              pipe anywhere.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-stone-50/75 max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-stone-950 rounded-lg p-3 font-mono text-xs text-stone-300 leading-5">
                    ...
                    <div>
                      <span className="text-blue-300">PERF_CONNECTION</span>=
                      <span className="text-emerald-300">pgsql</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-emerald-950 p-8 lg:p-10">
              ...
              <p className="text-emerald-200/80 text-sm mb-6 leading-relaxed">
                Send your AI agent to this URL. It contains a complete skill
                that tells the agent how to install and use laraperf.
              </p>
              <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-stone-500 text-sm max-w-xs leading-relaxed">
                ...
                purpose-built for AI coding agents. MIT License.
              </p>
